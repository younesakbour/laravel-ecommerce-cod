              ...
              <div class="inline-block w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg  dark:bg-black">
                  <table class="w-full bg-gray">
                      <thead style="width: 100% ">
                          <tr class="w-100">
                              <th
                                  class="px-6 py-3 text-xlg font-medium  tracking-wider text-left text-gray  uppercase border-b border-gray-200 bg-gray-50">
                                  CATEGORY Name</th>
                                  <th
                            ...
                            <td class="px-6  whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 w-10 h-10">
                                        <img class="w-13 h-12 " 
                                        src="{{ asset('imgs').'/categorie/'.$item->ico }}"
                                        alt="admin dashboard ui">
                                    </div>
    
                                    <div class="ml-4">
                                        <div class="text-lg font-medium leading-5 text-gray-900  dark:text-white">
                                           {{ $item->name }}
                                        </div>
                                    </div>
                                </div>
